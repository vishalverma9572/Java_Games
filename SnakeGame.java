...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    SnakeGame(int boardWidth, int boardHeight) {
		...
		//game timer
		gameLoop = new Timer(speed, this); //how long it takes to start timer, milliseconds gone between frames 
        // gameLoop.start();
        // paused=true;
	}	
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_UP && velocityY != 1) {
            ...
            // Stop or start the Timer based on the paused state
            if (paused) {
                gameLoop.stop();
            } else {
                gameLoop.start();
    ...
    //increasing speed level as size increaseing
    public void speedLevel() {
        speed = speed - (int) (120.0 / 250.0) * snakeBody.size();
    }
